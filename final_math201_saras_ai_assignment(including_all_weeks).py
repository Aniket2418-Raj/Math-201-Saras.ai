# -*- coding: utf-8 -*-
"""Final Math201-Saras Ai Assignment(including all weeks).ipynb
...
***Final Testing, Evaluation, and Reflection***
...
"""Training Curves (Presentation-Ready)"""
...
feature_extractor = Model(
    inputs=final_model.layers[0].input,  # Use the input of the first layer
    outputs=final_model.layers[-3].output  # 128-D vector
)
...
plt.title("PCA of Learned Feature Vectors")
plt.xlabel("Principal Component 1")
plt.ylabel("Principal Component 2")
plt.show()

"""**Evolution of Vector Representations**

***Initial Representation***

1. Each image was initially represented as a 784-dimensional raw pixel vector obtained by flattening the 28×28 grayscale image.

2. These vectors contained low-level intensity information with minimal semantic meaning.

***Feature Transformation Through Learning***

1. As training progressed, the neural network transformed raw pixel vectors into progressively higher-level feature representations.

2. Early layers learned simple features such as edges and contours.

3.Deeper layers captured more abstract patterns, including textures, shapes, and category-specific structures.

***Semantic Structure in Feature Space***

1. The final hidden-layer vectors encoded meaningful semantic information.

2. Images belonging to the same category were mapped closer together in the learned vector space.

***PCA-Based Visualization***

1. Principal Component Analysis (PCA) revealed clear clustering of feature vectors.

2. Visually distinct categories such as footwear and bags formed well-separated clusters.

3. This indicates strong class-level discrimination learned by the model.

***Class Overlap and Limitations***

1. Partial overlap was observed between visually similar categories, particularly Shirt and T-shirt/top.

2. This overlap reflects inherent visual similarity rather than a failure of the model.

***Overall Insight***

1. The model successfully converted raw image pixels into compact, informative vector representations.

2. These learned vectors enabled accurate classification and effective generalization to unseen data.

3. The experiment highlights the importance of vector-based transformations in deep learning for image classification.
"""